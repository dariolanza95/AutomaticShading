...
float cell_scale = 30;
        float scale = M_PI*2/15;

        float maxdist = cell_scale*2;//+ 10*(1-cell_scale);
      //  scale = scale   * 10 ;
        float *data;
        float point[3];
        float normal[3];
